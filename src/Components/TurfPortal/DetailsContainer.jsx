  ...
  return (
    <>
      ...
      <div className="flex justify-center items-center  w-full">
        <DetailsForm
          amenityModal={amenityModal}
          setAmenityModal={setAmenityModal}
      ...
      {amenityModal && (
        <RuleAmenityModal
          title={"Amenity"}
          modal={amenityModal}
          setModal={setAmenityModal}
          handleSubmit={amenityHandleSubmit}
          data={amenityData}
        />
      )}
      {rulesModal && (
        <RuleAmenityModal
          title={"Rules"}
          modal={rulesModal}
          setModal={setRulesModal}
          handleSubmit={rulesHandleSubmit}
          data={rulesData}
        />
      )}
    </>
