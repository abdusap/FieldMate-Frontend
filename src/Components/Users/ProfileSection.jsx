            ...
            <div className="md:w-1/2 flex flex-col justify-center items-center">
              ...
              <div className="">
                ...
                <div>
                  <input
                    ...
                    type="file"
                    className="mt-2 mb-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 focus:outline-none block w-full p-2.5"
                  />
                </div>
                {error && (
                ...
                <div className="flex justify-center">
                  {
                    <button
                      ...
                      type="button"
                      class="text-white  justify-center  w-36 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 inline-flex items-center"
                    >
                      {loading ? (
                        <>
                          <svg
              ...
              <div>
                <p className="font-semibold mt-2">
                  Wallet Balance: <span>₹{details.wallet}</span>
                </p>
              </div>
            </div>
            <div className="md:w-1/2">
              <form onSubmit={handleSave}>
                ...
                <div className="flex justify-center my-3">
                  <button
                    type="submit"
                    className="px-2 py-1 text-white w-24 bg-blue-700  rounded-lg"
                  >
                    Save
                  </button>
                </div>
