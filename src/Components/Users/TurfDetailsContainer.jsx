    ...
    <>
     <div>
        ...
        <div className='w-full bg-white border-t-2 pl-8 border-b-2'>
          <p className='text-lg font-bold p-1'>Beach Arena</p>
...
Calicut</p>
        ...
        <div className='flex bg-white w-11/12 mx-auto p-4 rounded-lg mt-4 '>
            <div className='h-64 w-80 ' style={{backgroundImage:'url(./image/abc1.jpg)'}}/>
            <div className='h-64 w-80 ml-3' style={{backgroundImage:'url(./image/abc1.jpg)'}}/>
        ...
        <div className='w-full flex justify-evenly flex-col md:flex-row mt-4 px-4  md:px-3 items-center md:items-stretch'>
          <div className='bg-white md:w-96 p-4 mb-4 rounded-lg w-full'>
            ...
            <span className='text-sm border border-black px-1 rounded-2xl mr-1'>Football</span>
            <span className='text-sm border border-black px-1 rounded-2xl mr-1'>Cricket</span>
            <span className='text-sm border border-black px-1 rounded-2xl mr-1'>Badminton</span>
          ...
          <button className='text-white bg-black px-3 rounded-lg ml-3'>Slots</button>
...
<a className='flex mt-2 ' href="https://www.google.com/search?q=palazhi+turf&rlz=1C1YTUH_enIN1020IN1021&oq=palazhi+turf&aqs=chrome..69i57.6461j0j4&sourceid=chrome&ie=UTF-8#"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mr-1 w-6 h-6">
