...
import { bookSlotApi, createOrderApi, getWalletAndPriceApi, paymentSuccessApi } from '../../Helpers/UserApi';
...
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-medium text-gray-900 ">{location.state.sportsName}</label>
...
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-normal text-gray-900 ">Slot Price:</label>

</div>
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-medium text-gray-900 ">₹{slotPrice}</label>
...
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-normal text-gray-900 ">Sub Total:</label>

</div>
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-medium text-gray-900 ">{`₹${location.state.slots.length*slotPrice}`}</label>
...
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-medium text-gray-900 ">2000</label>
...
:<p className='font-normal text-sm ml-2'>Your wallet Balance is ₹0</p>
}
</div>
               {walletUsed!==0 &&
...
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-normal text-gray-900 ">Wallet Used:</label>

</div>
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-medium text-gray-900 ">₹{walletUsed}</label>
...
<div className='w-1/2'>
<label for="first_name" class="block mb-1 mt-2 text-sm font-medium text-gray-900 ">₹{total}</label>
            ...
            <input required   type="date"  id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 focus:outline-none block w-full md:w-[22rem] p-2.5 mb-4" placeholder="Email" />
        </div> */}
...
<div className='flex '>
    <button type='submit' onClick={handleBooking} className='mx-auto bg-black text-white px-2 rounded-lg py-1 mt-4'>{`${total===0?"Book":"Pay"}`}</button>
</div>
