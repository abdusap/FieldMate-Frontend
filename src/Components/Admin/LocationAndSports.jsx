    ...
    <>
      ...
      <div className="flex md:flex-row flex-col pt-4 h-[33rem] overflow-auto">
        <div className="flex flex-col md:w-1/2 md:p-2 p-1 flex-grow">
          ...
          <button
            className="bg-blue-400 rounded-lg p-1 text-sm font-semibold flex text-center self-end w-max"
            onClick={addlocation}
          >
            Add Location
          </button>
          <TableLocationAndSports
            data={location}
            head={"Location"}
            handleEdit={EditLocation}
            handleBlock={blockLocation}
          />
        </div>
        <div className="flex flex-col md:w-1/2 md:p-2  p-1 flex-grow">
          ...
          <TableLocationAndSports
            data={sports}
            head={"Sports"}
            handleEdit={editSports}
            handleBlock={blockSports}
          />
        </div>
      </div>
    </>
