...
function TurfDetailsInVerification({name,email,mobile,location,coordinates,id,handleAccept,handleReject,verificationStatus}) {
  return (
    <>
       <div className='border-black border rounded-md my-2 md:py-2 shadow-xl'>
                      <div className='flex flex-col md:flex-row'>
                        <div className=' md:w-1/2 px-1'>
                            <p className='text-base font-semibold'>Name:<span className='font-normal'> {name}</span></p>                    
                            <p className='text-base font-semibold'>Email:<span className='font-normal'> {email}</span></p>                    
                            <p className='text-base font-semibold'>Mobile:<span className='font-normal'> {mobile}</span></p>                    
