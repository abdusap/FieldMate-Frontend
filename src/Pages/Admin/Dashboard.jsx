...
function Dashboard() {
  ...
  useEffect(()=>{
    dashboardDetailsApi().then((res)=>{
      ...
      // const turfCount=turfDetails.length
  ...
  return (
    ...
    <div className='flex md:flex-row justify-around mt-2 md:mt-8 flex-col'>
      ...
      <Cards colour={' bg-green-600'} head={'Pending verification'} body={pendingTurf}/>
    </div>
    <Graph label1={"Cancelled Turf"} label2={"Users"} label3={"Turf Approved"} label4={"Turfs"} data1={rejectedTurf} data2={userCount} data3={approvedTurf} data4={turfCount}/>
