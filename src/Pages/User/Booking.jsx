...
<BookingBox groundName={data.groundName} sports={data.sports} slots={data.slots} status={data.status} id={data._id} date={data.date} bookingType={'active'}/>
)
}
...
<BookingBox groundName={data.groundName} sports={data.sports} slots={data.slots} status={data.status} id={data._id} date={data.date} bookingType={''}/>
)
