    ...
    <div className='py-6 flex'>
        <div className='bg-white w-fit p-10 mx-auto rounded-md'>
          <p className='text-base font-semibold  text-center'>Slot Details</p>
            ...
            <input   type="date" id="first_name" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 focus:outline-none block w-full p-2.5" placeholder="Email" />
        </div>
        {/* <div>
